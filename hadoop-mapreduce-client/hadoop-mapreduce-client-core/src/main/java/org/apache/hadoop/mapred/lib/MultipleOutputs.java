...
public class MultipleOutputs {
  ...
  private static final String NAMED_OUTPUTS = "mo.namedOutputs";//按照空格拆分

  private static final String MO_PREFIX = "mo.namedOutput.";//文件名的前缀

  private static final String FORMAT = ".format";
  private static final String KEY = ".key";
  private static final String VALUE = ".value";
  private static final String MULTI = ".multi";//文件名的后缀
   ...
   * @param namedOutput named output Name
   * @throws IllegalArgumentException if the output name is not valid.
   * 校验文件名必须是字符或者数字组成,并且不能等于part
   */
  private static void checkNamedOutputName(String namedOutput) {
    checkTokenName(namedOutput);//校验文件名必须是字符或者数字组成
  ...
  private Set<String> namedOutputs;//输出目录集合
