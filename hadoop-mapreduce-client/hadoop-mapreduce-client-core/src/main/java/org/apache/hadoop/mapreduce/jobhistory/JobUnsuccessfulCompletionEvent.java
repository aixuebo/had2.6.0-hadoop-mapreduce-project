...
public class JobUnsuccessfulCompletionEvent implements HistoryEvent {
   ...
   * @param id Job ID
   * @param finishTime Finish time of the job 完成事件
   * @param finishedMaps Number of finished maps 成功完成的map数量
   * @param finishedReduces Number of finished reduces 成功完成的reduce数量
   * @param status Status of the job 完成时候的job状态
   */
