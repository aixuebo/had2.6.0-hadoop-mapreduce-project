...
public class JobStatus implements Writable, Cloneable {
  ...
  /**
   * Current state of the job 当前job的状态
   */
  ...
  private JobID jobid;//job的序列号
  private float mapProgress;//map的进度
  private float reduceProgress;//reduce进度
  private float cleanupProgress;
  private float setupProgress;
  
  private State runState;//当前状态
  ...
  private String jobFile;//job的配置文件path
  private long finishTime;
  private boolean isRetired;//该job是否预约
  private String historyFile = "";//job完成之后历史文件的path
  private String trackingUrl ="";//trackingUrl link to the web-ui for details of the job. 可以查看该job信息的httpUrl
