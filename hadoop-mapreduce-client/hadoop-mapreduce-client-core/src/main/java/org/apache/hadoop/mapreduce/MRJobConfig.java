...
public interface MRJobConfig {
  ...
  // consistent.
  public static final String INPUT_FORMAT_CLASS_ATTR = "mapreduce.job.inputformat.class";//输入格式化类

  public static final String MAP_CLASS_ATTR = "mapreduce.job.map.class";//map类

  public static final String MAP_OUTPUT_COLLECTOR_CLASS_ATTR
                                  = "mapreduce.job.map.output.collector.class";

  public static final String COMBINE_CLASS_ATTR = "mapreduce.job.combine.class";//combine类

  public static final String REDUCE_CLASS_ATTR = "mapreduce.job.reduce.class";//reduce类

  public static final String OUTPUT_FORMAT_CLASS_ATTR = "mapreduce.job.outputformat.class";//输出格式化类

  public static final String PARTITIONER_CLASS_ATTR = "mapreduce.job.partitioner.class";//partitioner对象
  ...
  public static final String JAR = "mapreduce.job.jar";//运行的jar包
  ...
  public static final String PRIORITY = "mapreduce.job.priority";//设置job的优先级
  ...
  public static final String OUTPUT_KEY_CLASS = "mapreduce.job.output.key.class";///最终job输出的key

  public static final String OUTPUT_VALUE_CLASS = "mapreduce.job.output.value.class";//最终job输出的value
  ...
  public static final String WORKING_DIR = "mapreduce.job.working.dir";//job的工作目录
  ...
  public static final String RECORDS_BEFORE_PROGRESS = "mapreduce.task.merge.progress.records";//处理多少条记录进行一次report报告
  ...
  public static final String MAP_MAX_ATTEMPTS = "mapreduce.map.maxattempts";//最大尝试次数
  ...
  public static final String MAP_FAILURES_MAX_PERCENT = "mapreduce.map.failures.maxpercent";//map失败的最大百分比
  ...
  public static final String MAP_OUTPUT_KEY_CLASS = "mapreduce.map.output.key.class";//map的输出key

  public static final String MAP_OUTPUT_VALUE_CLASS = "mapreduce.map.output.value.class";//map阶段的输出value
  ...
  public static final String REDUCE_FAILURES_MAXPERCENT = "mapreduce.reduce.failures.maxpercent";//reduce任务最大的失败百分比
  ...
  public static final String MAPREDUCE_JOB_DIR = "mapreduce.job.dir";//该job提交的各种文件和jar存储的根目录
  ...
  public static final String JOB_ACL_VIEW_JOB = "mapreduce.job.acl-view-job";//读、查看job权限

  public static final String DEFAULT_JOB_ACL_VIEW_JOB = " ";

  public static final String JOB_ACL_MODIFY_JOB = "mapreduce.job.acl-modify-job";//可以修改的job权限
