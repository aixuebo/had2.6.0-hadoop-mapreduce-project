...
public class DBConfiguration {
  ...
  public static final String DRIVER_CLASS_PROPERTY = 
    "mapreduce.jdbc.driver.class";//driver的字符串key
  
  /** JDBC Database access URL 数据库url的字符串key*/
  public static final String URL_PROPERTY = "mapreduce.jdbc.url";

  /** User name to access the database 数据库用户名的字符串key*/
  public static final String USERNAME_PROPERTY = "mapreduce.jdbc.username";
  
  /** Password to access the database 数据库密码的字符串key*/
  ...
  /** Class name implementing DBWritable which will hold input tuples DBWritable序列化实现类*/
   ...
   * 设置数据库驱动、数据库连接、用户名、密码设置到conf配置文件中
   */
   ...
   * @throws SQLException 
   * 从conf配置文件中获取数据库连接串、用户名、密码等信息,创建Connection连接
   * */
