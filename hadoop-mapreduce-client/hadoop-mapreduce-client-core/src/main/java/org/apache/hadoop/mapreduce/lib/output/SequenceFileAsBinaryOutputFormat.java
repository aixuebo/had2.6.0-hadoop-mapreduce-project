 ...
 * 写入value的数据,按照字节数组方式写入
 * 
 * 注意:不支持CompressionType.RECORD方式压缩
 */
@InterfaceAudience.Public
@InterfaceStability.Stable
public class SequenceFileAsBinaryOutputFormat 
    extends SequenceFileOutputFormat <BytesWritable,BytesWritable> {
  public static String KEY_CLASS = "mapreduce.output.seqbinaryoutputformat.key.class"; //key对应的class
  public static String VALUE_CLASS = "mapreduce.output.seqbinaryoutputformat.value.class"; //value对应的class
