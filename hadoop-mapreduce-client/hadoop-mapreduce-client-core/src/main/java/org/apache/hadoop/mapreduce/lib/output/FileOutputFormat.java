 ...
 * 2.设置和获取压缩方式
 * 3.设置和获取输出的路径
 * 4.  public abstract RecordWriter<K, V> 抽象方法
...
public abstract class FileOutputFormat<K, V> extends OutputFormat<K, V> {
  ...
  protected static final String BASE_OUTPUT_NAME = "mapreduce.output.basename";//可以改变part名字
...
public static final String COMPRESS ="mapreduce.output.fileoutputformat.compress";//是否压缩
public static final String COMPRESS_CODEC = 
"mapreduce.output.fileoutputformat.compress.codec";//压缩方式
public static final String COMPRESS_TYPE = "mapreduce.output.fileoutputformat.compress.type";
public static final String OUTDIR = "mapreduce.output.fileoutputformat.outputdir";//输出目录
