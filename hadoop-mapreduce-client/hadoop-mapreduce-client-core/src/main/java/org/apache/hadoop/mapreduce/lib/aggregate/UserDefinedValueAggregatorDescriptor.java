...
public class UserDefinedValueAggregatorDescriptor implements
  ...
  private String className;//类名全路径

  //className全路径对应的实例化对象
  ...
  /**
   * 创建一个实例化ValueAggregatorDescriptor对象
   */
   ...
   * 根据className,创建一个实例化ValueAggregatorDescriptor对象
   */
