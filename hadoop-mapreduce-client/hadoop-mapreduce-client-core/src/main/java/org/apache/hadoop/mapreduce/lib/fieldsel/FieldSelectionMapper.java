...
public class FieldSelectionMapper<K, V>
  ...
  private String mapOutputKeyValueSpec;//map的输出需要的匹配方式

  private boolean ignoreInputKey;//是否忽略key,当是TextInputFormat类型的InputFormat时候,设置该值为true

  private String fieldSeparator = "\t";//拆分每一行的字符串
