 ...
 * 访问ClientProtocol的一个代理类,大多数方法还是访问的ClientProtocol实现的
 */
...
public class Cluster {
  ...
  private ClientProtocolProvider clientProtocolProvider;//ClientProtocolProvider实现类,是该类创建了ClientProtocol client对象
  private ClientProtocol client;//创建ClientProtocol对象实例化,该对象是客户端对象
  ...
  /**
   * 初始化
   * 创建ClientProtocol对象实例化,该对象是客户端对象
   * @param jobTrackAddr,ClientProtocol服务器的地址,程序去连接该地址创建ClientProtocol对象
   * @param conf
   * @throws IOException
   */
