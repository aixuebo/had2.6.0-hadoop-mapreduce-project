...
public class ContainerLauncherEvent 
  ...
  private TaskAttemptId taskAttemptID;//尝试任务
  private ContainerId containerID;//该任务所在的容器
  private String containerMgrAddress;//容器所在的http地址
  private Token containerToken;//容器所在的校验器
