...
public class MRAppMetrics {
  @Metric MutableCounterInt jobsSubmitted;//被提交的job个数
  @Metric MutableCounterInt jobsCompleted;//job完成的次数
  @Metric MutableCounterInt jobsFailed;//job失败的次数
  @Metric MutableCounterInt jobsKilled;//job被kill次数
  @Metric MutableGaugeInt jobsPreparing;//当前预备中的job个数,在处于初始化job中的job数量
  @Metric MutableGaugeInt jobsRunning;//正在运行的job数量
