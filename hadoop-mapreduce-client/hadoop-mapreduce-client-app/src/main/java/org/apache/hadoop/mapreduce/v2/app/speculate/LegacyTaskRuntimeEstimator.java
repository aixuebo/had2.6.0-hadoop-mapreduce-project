...
public class LegacyTaskRuntimeEstimator extends StartEndTimesBase {
  ...
  private final ConcurrentHashMap<TaskAttempt, AtomicLong> attemptRuntimeEstimateVariances = new ConcurrentHashMap<TaskAttempt, AtomicLong>();
  ...
  public void updateAttempt(TaskAttemptStatus status, long timestamp) {
    ...
    //  1: If this is a completion, we accumulate statistics in the superclass 如果已经完成了该任务,则在父类中已经计算到统计中了
    //  2: If this is not a completion, we learn more about it. 如果没有完成,则我们要学习更多的信息

    // This is not a completion, but we're cooking. 如果没有完成,我们要这么做
    //
